...
var es_default = {
  ...
  "wheelZoom.label": "Zoom con rueda",
  "modal.close": "Cerrar"
};
...
var fr_default = {
  ...
  "wheelZoom.label": "Zoom \xE0 la molette",
  "modal.close": "Fermer"
};
...
var ru_default = {
  ...
  "wheelZoom.label": "\u041C\u0430\u0441\u0448\u0442\u0430\u0431\u0438\u0440\u043E\u0432\u0430\u043D\u0438\u0435 \u043A\u043E\u043B\u0435\u0441\u043E\u043C",
  "modal.close": "\u0417\u0430\u043A\u0440\u044B\u0442\u044C"
};
...
var pt_BR_default = {
  ...
  "wheelZoom.label": "Zoom com a roda",
  "modal.close": "Fechar"
};
...
var MermaidZoomSettingTab = class extends import_obsidian2.PluginSettingTab {
  ...
  display() {
    ...
    containerEl.empty();
    new import_obsidian2.Setting(containerEl).setName(t("setting.defaultZoom.name")).setDesc(t("setting.defaultZoom.desc")).addSlider((slider) => slider.setLimits(50, 300, 5).setValue(this.plugin.settings.defaultZoom).setDynamicTooltip().onChange(async (value) => {
...
var MermaidZoomPlugin = class extends import_obsidian4.Plugin {
  ...
  createControls(container, contentWrapper, state) {
    ...
    wheelZoomLabel.style.cssText = `
			...
			white-space: nowrap;
		`;
    new import_obsidian4.ToggleComponent(wheelZoomToggle).setValue(state.wheelZoomEnabled).onChange((value) => {
