...
| ADR-0012 | Kubernetes 发现、Tcaplus 权威路由与主动发布的 Coordinator | Current Coordinator evolution target；以 Kubernetes Lease + Tcaplus CAS 替代 ADR-0008 的生产 2/3 Route Log 实现选择，保留单 Owner、epoch 和 Fence。 |
