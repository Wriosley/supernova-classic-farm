...
related:
  ...
  - ../context/CURRENT.md
  - ../archive/evidence/historical/2026-08-03-r3-snapshot-read-baseline.zh-CN.md
---
...
这些数字不能外推成“已支持 3000 万 DAU”：当前只测了单机读路径，尚未测写 Actor、Push、Dirty、长期连接、资源占用和多机网络成本。完整数据见 `../archive/evidence/historical/2026-08-03-r3-snapshot-read-baseline.zh-CN.md`。
...
- 当前中文性能报告：`../archive/evidence/historical/2026-08-03-r3-snapshot-read-baseline.zh-CN.md`
