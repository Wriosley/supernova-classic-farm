...
- Preserve `docs/archive/development/plans/2026-07-27-30m-dau-architecture-strategy-and-open-questions-plan.md`; Task 3 intentionally edits and commits it.
...
?? docs/.obsidian/
?? docs/archive/development/plans/2026-07-27-30m-dau-architecture-strategy-and-open-questions-plan.md
```
...
- Modify: `docs/archive/development/plans/README.md`
- Modify: `docs/evidence/README.md`
- Modify: `docs/archive/development/ai-workflow/README.md`
...
- `docs/archive/development/plans/`：开放问题看板和实施计划。
...
Append this paragraph to `docs/archive/development/plans/README.md`:
...
Append this sentence to `docs/archive/development/ai-workflow/README.md`:
...
3. `docs/archive/development/plans/2026-07-27-30m-dau-architecture-strategy-and-open-questions-plan.md` for unresolved architecture work;
...
- Major tradeoffs receive ADRs, implementation order stays in `docs/archive/development/plans/`, and executed tests or measurements go to `docs/evidence/`.
...
```powershell
rg -n 'docs/README.md|docs/modules|docs/contracts|open-question|事实来源|source-of-truth' AGENTS.md CLAUDE.md README.md docs/context/CURRENT.md docs/requirements/README.md docs/archive/development/plans/README.md docs/evidence/README.md docs/archive/development/ai-workflow/README.md
git diff --check -- AGENTS.md CLAUDE.md README.md docs/context/CURRENT.md docs/requirements/README.md docs/archive/development/plans/README.md docs/evidence/README.md docs/archive/development/ai-workflow/README.md
```
...
```powershell
git add -- AGENTS.md CLAUDE.md README.md docs/context/CURRENT.md docs/requirements/README.md docs/archive/development/plans/README.md docs/evidence/README.md docs/archive/development/ai-workflow/README.md
git diff --cached --check
...
**Files:**
- Modify and add to Git: `docs/archive/development/plans/2026-07-27-30m-dau-architecture-strategy-and-open-questions-plan.md`
...
```powershell
git diff --check -- docs/archive/development/plans/2026-07-27-30m-dau-architecture-strategy-and-open-questions-plan.md
rg -n 'A-10|C-13|D-11|F-09|route_epoch|base_version|三个客户端.*验收基线' docs/archive/development/plans/2026-07-27-30m-dau-architecture-strategy-and-open-questions-plan.md
rg -n 'status: accepted|生产.*最多三人' docs/archive/development/plans/2026-07-27-30m-dau-architecture-strategy-and-open-questions-plan.md
```
...
```powershell
git add -- docs/archive/development/plans/2026-07-27-30m-dau-architecture-strategy-and-open-questions-plan.md
git diff --cached --check
