...
func (x *ApplyMailRewardRequest) GetCoinAmount() int64 {
	if x != nil {
		return x.CoinAmount
	}
	return 0
...
type ApplyMailRewardResponse struct {
	...
	CoinsAdded    int64     `protobuf:"varint,6,opt,name=coins_added,json=coinsAdded,proto3" json:"coins_added,omitempty"`
	Error         *ws.Error `protobuf:"bytes,15,opt,name=error,proto3" json:"error,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *ApplyMailRewardResponse) GetCoinsAdded() int64 {
	if x != nil {
		return x.CoinsAdded
	}
	return 0
...
const file_classicfarm_v1_rpc_runtime_proto_rawDesc = "" +
	...
	"\bquantity\x18\x02 \x01(\rR\bquantity\"\x9d\x02\n" +
	...
	"\vattachments\x18\x05 \x03(\v2(.classicfarm.rpc.v1.MailRewardAttachmentR\vattachments\x12\x1f\n" +
