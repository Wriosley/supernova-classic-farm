// TcaplusService option Ver.1, distributed by Tencent with the Go SDK.
...
var (
	...
	E_TcaplusPrimaryKey = &file_tcaplusservice_optionv1_proto_extTypes[0]
	// repeated string tcaplus_index = 60001;
	E_TcaplusIndex = &file_tcaplusservice_optionv1_proto_extTypes[1]
	// optional string tcaplus_field_cipher_suite = 60002;
	E_TcaplusFieldCipherSuite = &file_tcaplusservice_optionv1_proto_extTypes[2]
	// optional string tcaplus_record_cipher_suite = 60003;
	E_TcaplusRecordCipherSuite = &file_tcaplusservice_optionv1_proto_extTypes[3]
	// optional string tcaplus_cipher_md5 = 60004;
	E_TcaplusCipherMd5 = &file_tcaplusservice_optionv1_proto_extTypes[4]
	// optional string tcaplus_sharding_key = 60005;
	E_TcaplusShardingKey = &file_tcaplusservice_optionv1_proto_extTypes[5]
	// optional string tcaplus_customattr = 60006;
	E_TcaplusCustomattr = &file_tcaplusservice_optionv1_proto_extTypes[6]
)

// Extension fields to descriptorpb.FieldOptions.
var (
	// optional uint32 tcaplus_size = 60000;
	E_TcaplusSize = &file_tcaplusservice_optionv1_proto_extTypes[7]
	// optional string tcaplus_desc = 60001;
	E_TcaplusDesc = &file_tcaplusservice_optionv1_proto_extTypes[8]
	// optional bool tcaplus_crypto = 60002;
	E_TcaplusCrypto = &file_tcaplusservice_optionv1_proto_extTypes[9]
)
...
const file_tcaplusservice_optionv1_proto_rawDesc = "" +
	...
	"\x0etcaplus_crypto\x12\x1d.google.protobuf.FieldOptions\x18\xe2\xd4\x03 \x01(\bR\rtcaplusCryptoBUZSgithub.com/Wriosley/supernova-classic-farm/server/gen/tcaplus/options;tcaplusoption"
